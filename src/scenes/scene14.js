    ...
    return new Promise((resolve) => {
      container.innerHTML = `
        <div style="position:relative;width:100%;height:100%;overflow:hidden;display:flex;flex-direction:column;align-items:center;justify-content:center;perspective:900px;">
          <!-- Ambient deep space -->
          <div style="position:absolute;inset:0;background:radial-gradient(circle at 50% 40%, rgba(200,130,148,0.08) 0%, rgba(200,162,72,0.05) 50%, rgba(10,6,8,0.98) 85%);pointer-events:none;"></div>
          ...
          <div id="t-frags-layer" style="position:relative;width:100%;max-width:340px;height:120px;display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:8px;z-index:10;margin-bottom:20px;">
            <span class="text-timestamp-sm" id="tf-1" style="opacity:0;background:rgba(250,245,238,0.05);padding:4px 8px;border-radius:5px;border:1px solid var(--cinema-border);">4:30 AM</span>
            <span class="text-timestamp-sm" id="tf-2" style="opacity:0;background:rgba(250,245,238,0.05);padding:4px 8px;border-radius:5px;border:1px solid var(--cinema-border);">5:30 AM</span>
            <span class="text-timestamp-sm" id="tf-3" style="opacity:0;background:rgba(250,245,238,0.05);padding:4px 8px;border-radius:5px;border:1px solid var(--cinema-border);">7:30 AM</span>
            <span class="text-timestamp-sm" id="tf-4" style="opacity:0;background:rgba(224,108,117,0.1);color:#e06c75;padding:4px 8px;border-radius:5px;border:1px solid rgba(224,108,117,0.2);">MISSED CALL</span>
            <span class="text-timestamp-sm" id="tf-5" style="opacity:0;background:rgba(250,245,238,0.05);padding:4px 8px;border-radius:5px;border:1px solid var(--cinema-border);">BUS</span>
            <span class="text-timestamp-sm" id="tf-6" style="opacity:0;background:rgba(250,245,238,0.05);padding:4px 8px;border-radius:5px;border:1px solid var(--cinema-border);">BROKEN KITKAT</span>
          </div>
          ...
          <div id="t-bond-stage" style="opacity:0;position:relative;width:100%;max-width:340px;height:120px;display:flex;align-items:center;justify-content:space-between;z-index:10;">
            ...
            <div style="display:flex;flex-direction:column;align-items:center;gap:4px;z-index:5;">
              <div style="width:48px;height:48px;border-radius:50%;background:rgba(250,245,238,0.08);border:1.5px solid var(--cinema-accent);display:flex;align-items:center;justify-content:center;font-size:1.2rem;box-shadow:0 4px 14px rgba(0,0,0,0.5);">
                👦
              </div>
            ...
            <!-- Anwesha Node -->
            <div style="display:flex;flex-direction:column;align-items:center;gap:4px;z-index:5;">
              <div style="width:48px;height:48px;border-radius:50%;background:rgba(250,245,238,0.08);border:1.5px solid var(--cinema-gold);display:flex;align-items:center;justify-content:center;overflow:hidden;box-shadow:0 4px 14px rgba(0,0,0,0.5);">
