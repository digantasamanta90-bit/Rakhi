# For Anwesha, From Your Brother 🧿

A personalized interactive Rakhi experience created with love, humor, and questionable sleep decisions by **Diganta** for **Anwesha**, paired with a physical **KitKat Rich** gift.
...
You can place custom media directly into the `assets/` folders:
- `assets/portraits/anwesha_hero.png` (Scene 2 & Scene 7 Hero Portrait)
- `assets/portraits/anwesha_calm.png` (Scene 5 Sincere Message Portrait)
- `assets/audio/rakhi_theme.mp3` (Custom background music - automatically overrides synth if present)

## 🚀 Running the Experience Locally

Simply serve with any static web server, for example:
```bash
npx serve .
# or
